 ...
 *  
 */
package de.hybris.platform.food.jalo;
...
import de.hybris.platform.food.constants.FoodConstants;



/**
 * This is the extension manager of the Food extension.
 */
public class FoodManager extends GeneratedFoodManager
{
	...
	{
		return (FoodManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FoodConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FoodManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FoodManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FoodManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FoodManager called, current tenant: " + getTenant().getTenantID());
		}
	}
